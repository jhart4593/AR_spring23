...
% n an integer, the 3-1-2 Euler representation is singular.  The intuition here
% is that when the roll angle is pi/2, the first and third rotations (about the
% z and y axes, respectively), have exactly the same effect, and so can't be
% distinguished, leading to a non-unique representation for psi and theta; only
% psi + theta is constrained, but not psi and theta individually.  This
